...
// Database hostname:
$config['dbConnection']['host'] = 'internal-db.s209388.gridserver.com';
// Database username:
$config['dbConnection']['user'] = 'db209388';
// Database password:
$config['dbConnection']['pass'] = 'Walrusness123!';
// Database name:
$config['dbConnection']['name'] = 'db209388_clashofclans';
// Database type:
